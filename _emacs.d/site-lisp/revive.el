...
;;; (c) 1994-1999 by HIROSE Yuuji [yuuji@ae.keio.ac.jp]
;;; $Id: revive.el,v 2.14 1999/08/26 07:27:52 yuuji Exp $
;;; Last modified Thu Aug 26 16:27:30 1999 on firestorm
...
;;;		(revive:prop-varlist x)		;list of pairs of (var . val)
;;;
;;;[For programmers]
;;;
...
(defvar revive:save-variables-mode-local-private
  '((dired-mode dired-actual-switches)
    (yatex-mode YaTeX-math-mode YaTeX-modify-mode))
...
(defun revive:mew ()
  ...
  (mew-summary-folder-create (revive:prop-buffer-name x)))
