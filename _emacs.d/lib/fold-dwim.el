...
;;
;; With respect to outline-minor-mode, dwim-fold provides two
;; different styles of usage.  The first is a "nested" style which
;; only shows top-level headings when you fold the whole buffer, and
;; then allows you to drill down progressively through the other
;; levels.  The other is a "flat" style, whereby folding the entire
;; buffer shows all headings at every level.
;;
