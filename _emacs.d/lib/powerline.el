...
(defpowerline arrow       "")
(defpowerline buffer-id   (propertize (car (or mode-line-buffer-identification
...
(defpowerline tracking    '(t tracking-mode-line-buffers))
...
(setq-default mode-line-format
              (list "%e"
                    ...
                    '(:eval (concat
                             ...
                             (powerline-tracking       'left       powerline-color1)
