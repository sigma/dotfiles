...
;; Copyright (C) 2002 Pieter Pareit <pieter.pareit@planetinternet.be>
...
;; Authors: Pieter Pareit <pieter.pareit@planetinternet.be>
...
(defconst graphviz-dot-mode-version "0.3"
...
(defcustom graphviz-dot-auto-indent-on-braces t
...
\\<graphviz-dot-mode-map>\\[grapviz-dot-complete-word] will toggle the possible
...
(and (require 'easymenu nil t)
     (easy-menu-define
      ...
      '("Graphviz"
        ...
        ["Comment Out Region" comment-region              (region-active-p)]
        "-"
        ["Compile"            compile                     t]
...
;;;;
(defun graphviz-dot-newline-and-indent (text)
  (save-excursion
    (beginning-of-line)
    (skip-chars-forward " \t")
    (graphviz-dot-indent-line))
...
(defun electric-graphviz-dot-terminate-line ()
  ...
  (if graphviz-dot-auto-indent-on-newline
      (graphviz-dot-newline-and-indent nil)))

(defun electric-graphviz-dot-open-brace ()
  "Terminate line and indent next line."
  (interactive)
  (if graphviz-dot-auto-indent-on-braces
...
(defun electric-graphviz-dot-semi ()
  "Terminate line and indent next line."
  (interactive)
  (if graphviz-dot-auto-indent-on-semi
      (graphviz-dot-newline-and-indent ";")))
