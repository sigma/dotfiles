...
(custom-set-variables
 ...
 '(ecb-layout-window-sizes (quote (("sigma" (0.1696969696969697 . 0.9811320754716981) (0.1696969696969697 . 0.49056603773584906) (0.1696969696969697 . 0.49056603773584906)))))
 ...
 '(generic-extras-enable-list (quote (alias-generic-mode apache-conf-generic-mode apache-log-generic-mode bat-generic-mode etc-fstab-generic-mode etc-modules-conf-generic-mode etc-passwd-generic-mode etc-services-generic-mode etc-sudoers-generic-mode fvwm-generic-mode hosts-generic-mode inetd-conf-generic-mode inf-generic-mode ini-generic-mode java-manifest-generic-mode java-properties-generic-mode mailagent-rules-generic-mode mailrc-generic-mode named-boot-generic-mode named-database-generic-mode prototype-generic-mode rc-generic-mode reg-generic-mode resolve-conf-generic-mode samba-generic-mode show-tabs-generic-mode vrml-generic-mode x-resource-generic-mode)))
...
")
 ...
 '(ibuffer-saved-filter-groups (quote (("default" ("sh" (mode . sh-mode)) ("emacs" (or (name . "^\\*scratch\\*$") (name . "^\\*Messages\\*$"))) ("org" (mode . org-mode)) ("latex" (or (mode . LaTeX-mode) (mode . latex-mode))) ("C(++)" (or (mode . c-mode) (mode . c++-mode))) ("FDD" (mode . tl-fdd-mode)) ("Java" (mode . java-mode)) ("lisp" (or (mode . emacs-lisp-mode) (mode . lisp-interaction-mode) (mode . ielm-mode) (mode . lisp-mode) (mode . slime-repl-mode))) ("python" (mode . python-mode)) ("dired" (mode . dired-mode)) ("irc" (or (mode . circe-mode) (mode . circe-server-mode) (mode . circe-query-mode) (mode . circe-channel-mode) (mode . rcirc-mode))) ("gnus" (or (mode . message-mode) (mode . bbdb-mode) (mode . mail-mode) (mode . gnus-group-mode) (mode . gnus-summary-mode) (mode . gnus-article-mode) (name . "^\\.bbdb$") (name . "^\\.newsrc-dribble")))))))
