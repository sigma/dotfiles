...
;;; This file was auto-generated on Thu Apr  3 17:54:54 2008 from files:
;;;  js2-vars.el
;;;  js2-util.el
;;;  js2-scan.el
;;;  js2-messages.el
...
(defvar js2-mode-version 20080403
  ...
  (let* ((pos (and (/= decl-type js2-LET) js2-token-beg))
    ...
    (while continue
      ...
      (if (or (= tt js2-LB) (= tt js2-LC))
        ...
        (js2-set-face js2-token-beg js2-token-end 'js2-variable-name-face t)
