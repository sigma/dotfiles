;;; incr.el ---                     -*- coding: utf-8 -*-

;; Copyright 2006 Ye Wenbin
;;
;; Author: wenbinye@163.com
;; Time-stamp: <16/11/2006 18:04:54 Yann Hodique>
;; Version: $Id: incr.el,v 0.0 <2006-10-21 14:49:52> ywb Exp $
;; Keywords:
...
;; with the same way.
;;
;; The command also can do with a rectangle region, for example, when
;; select a rectangle like this:
;;   7
;;   7
;;   7
...
(defvar incr-version "1.2")

(defvar incr-rotate-text
...
(defvar incr-extend-chars "a-zA-Z0-9"
  "The rectangle region will extend when possible")

(defvar incr-enable-feature
